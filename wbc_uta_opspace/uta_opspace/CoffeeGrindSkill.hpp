...
#ifndef UTA_OPSPACE_COFFEE_GRIND_SKILL_HPP
#define UTA_OPSPACE_COFFEE_GRIND_SKILL_HPP
...
namespace uta_opspace {
  ...
  protected:
    ...
    TestVarGainCartPosTask * ee_task_;
    TestPureJointTask * posture_;
...
#endif // UTA_OPSPACE_COFFEE_GRIND_SKILL_HPP
