...
#ifndef UTA_OPSPACE_MULTI_JOINT_POS_HPP
#define UTA_OPSPACE_MULTI_JOINT_POS_HPP
...
namespace uta_opspace {
  ...
  protected:
    ...
    TestPureJPosTrajTask * jpos_task_;
    task_table_t task_table_;
    
    Parameter * jpos_goal_;
...
#endif // UTA_OPSPACE_MULTI_JOINT_POS_HPP
